...
import img2 from "../images/play.jpg";
import img3 from "../images/app.jpg";
// #004BBE
const hero_data = {
  id: "Extra",
  heading: "Earn extra on your spending and savings",
  description:
    "The plan that makes your money go even further with cash back on every purchase and high interest savings for just $9 per month.",
  img1: require("../images/extra_hero1.jpg"),
  img2: require("../images/essential_hero2.jpg"),
  color: "#004BBE",
  card_img: require("../images/extra_card.jpg"),
  card_list: [
...
const review_data = {
  ...
  list: [
    "Convenient & nice rewards! Superb for managing tight budgets in our current environment!",
    "Awesome, easy to use service! There are lots of great incentives.",
    "Saving made easy",
  ],
